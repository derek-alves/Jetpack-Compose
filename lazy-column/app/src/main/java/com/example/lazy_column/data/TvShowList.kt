...
import com.example.lazy_column.R
...
object TvShowList {
    ...
    val tvShows = listOf(
        ...
        TvShow(
            ...
            overview = "A small Norwegian town experiencing warm winters and violent downpours seems to be headed for another Ragnarok -- unless someone intervenes in time."
        ),
        TvShow(
            id = 3,
            name = "The Flash",
